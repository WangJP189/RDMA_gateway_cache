...
数字提取：把 B=2048 p50/p90 + B=1024 p50（6 方法）写 out/exp1a_store/exp1a_numbers.md
...
def main():
    ...
    r.append("\n条件（论文 3.1 正文）：N=4096，batch B=2048 主矩阵，R=5 runs，单位 ns；"
             "B=1024 为交叉验证。横轴 packet size（256/512/1024/2048/4096 B）、纵轴 store time cost（ns），双对数。"
             "主指标 p50，次指标 p90（p99 仅 CSV 留痕，实机尾部干净、备查）。"
